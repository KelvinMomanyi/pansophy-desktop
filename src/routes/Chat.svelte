...
<div class="flex w-full h-screen">
  ...
  <div class="w-full h-full flex flex-col items-center justify-center px-3 gap-2">
    ...
    <div class="flex justify-between items-center w-full bg-black/60 py-3 px-[14px] rounded-[12px] font-poppins font-light text-[15px">
    ...
    <div class="shadow-lg p-[24px] bg-black rounded-[20px] min-w-md flex flex-col gap-[15px] max-w-md relative">
      ...
      <div class="text-white flex flex-col gap-4 justify-center items-center w-full h-full">
        ...
        <div class="flex items-center gap-4">
          <button on:click={onClose} class="bg-white/24 backdrop-filter backdrop-blur-xl py-[4px] px-[14px] rounded-full">
              <p class="font-poppins font-light text-[14px]">Yes</p>
          </button>
          <div class="bg-white/24 backdrop-filter backdrop-blur-xl py-[4px] px-[14px] rounded-full">
...
{/if}
  ...
  <div class={`flex-1 flex flex-col items-center justify-end ${!isTab && !isOpen ? 'max-w-6/8' : ''} pt-8 gap-[33px]`}>

    <!-- Chat history -->
    <div
      bind:this={chatContainer}
      class="flex flex-col gap-[10px] overflow-y-auto w-full max-h-[60vh] px-4 overflow-y-auto no-scrollbar"
    >
      <div class="p-[24px] bg-black/40 rounded-[20px] flex flex-col gap-[15px]">
        <p class="font-poppins font-normal text-[20px]">
      ...
      {#each messages as message (message + Math.random())}
        <div class="flex justify-end w-full">
          <div class="p-[14px] bg-[#2563EB99]/60 rounded-[20px]">
            <p class="font-poppins font-light max-w-[365px] text-[14px]">{message}</p>
          </div>
        </div>
      {/each}
    </div>
      ...
      <div class="flex flex-col w-full min-h-[114px] rounded-[26px] p-[6px] gap-[14px] bg-black/40">
        ...
        <div class="flex w-full justify-between gap-[9px]">
          <div class="flex items-center gap-[10px]">
            ...
            <div class="bg-white/24 backdrop-filter backdrop-blur-xl py-[8px] px-[14px] rounded-full">
